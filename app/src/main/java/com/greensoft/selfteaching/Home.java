...
//        rateUs();
    ...
    private void createSlider() {
        ...
        imageList.add(new SlideModel(R.drawable.slider_1, "Self Teaching", null));
        imageList.add(new SlideModel(R.drawable.slider_2, "Self Teaching", null));
...
/*    private void rateUs(){
        cseDept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String cseDeptLink = "http://cse.green.edu.bd/";
                try {
                    WebBrowser.WEBSITE_LINK = cseDeptLink;
                    WebBrowser.WEBSITE_TITLE = "CSE Dept, GUB";
                    targetActivity = new Intent(Home.this, WebBrowser.class);
                    startActivity(targetActivity);
                } catch (android.content.ActivityNotFoundException e) {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(cseDeptLink)));
                }
